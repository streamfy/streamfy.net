<template>
  <div class="relative">
    <section
      class="bg-white text-gray-900 text-sm rounded outline-none block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      <SharedOnClickOutside :clickOutside="() => (showOptions = false)">
        <div
          ...
          <div class="relative">
            <input
              ...
              class="w-full p-2 outline-none block rounded text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Add tag..."
        ...
        <ul
          v-if="showOptions"
          class="absolute w-full max-h-40 mb-5 rounded overflow-y-auto z-10 py-1 dark:bg-gray-700 bg-white shadow-lg">
          <li
        ...
        <ul
          class="absolute w-full max-h-40 mb-5 rounded overflow-y-auto z-10 py-1 dark:bg-gray-700 bg-white shadow-lg"
          v-if="showOptions && !filterResult.length">
          <li
            class="px-3 py-1 text-sm text-gray-700 hover:text-white dark:text-white cursor-pointer hover:bg-blue-500 text-center">
            No item found
          </li>
        </ul>
...
<style scoped>
/* .custom-multi-select {
  @apply bg-white  text-gray-900 text-sm rounded  outline-none  block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500;
} */
/* .custom-input {
  @apply w-full p-2 outline-none  block rounded  text-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500;
} */
/* .list-items {
